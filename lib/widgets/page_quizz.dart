...
import 'package:flutter_codabee_quizz/models/question.dart';
import 'custom_text.dart';


class PageQuizz extends StatefulWidget {
  @override
  _PageQuizzState createState() {
...
class _PageQuizzState extends State<PageQuizz> {
  ...
  Future<Null> dialog(bool b) async {
    bool bonneReponse = question.reponse == b;
    if(bonneReponse){
      score++;
    }
    ...
    barrierDismissible: false,
      builder: (BuildContext buildContext){
        return new AlertDialog(
          ...
          content: new CustomText("Votre scrore $score/${index + 1}", color: Colors.green[900],),
          actions: [
            new FlatButton(
                onPressed: (){
